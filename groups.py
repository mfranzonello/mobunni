...
class Details(Group):
    ...
    '''
    def __init__(self, n_sites:int, n_years:int, n_runs:int, n_scenarios:int):
        Group.__init__(self)
...
class Commitments(Group):
    ...
    def __init__(self, **kwargs):
        ...
        self.deal = kwargs.get('deal', 'CapEx')
        ...
        self.data = [['contract length', self.length],
                     ...
                     ['contract financing type', self.deal],
